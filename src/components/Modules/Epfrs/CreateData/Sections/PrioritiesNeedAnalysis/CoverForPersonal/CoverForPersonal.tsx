              ...
              return (
                <td key={"7hs"+i} className={``}>
                  <Input
                    ...
                    value={section7.answer.clientData[i].coverForPersonalAccident.amountNeeded}
              ...
              return (
                <td key={"ysd"+i} className={``}>
                  <Input
                    ...
                    name="amountNeeded"
                    dataType="coverForPersonalAccident"
                    value={section7.answer.dependantData[i].coverForPersonalAccident.amountNeeded}
            ...
            <td className='w-1/2 align-top'>
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="col-span-1 mt-2">
                  <input type="checkbox" onChange={handleDefaultCheck} name="cover_for_personal_accident_benefit" checked={section7.answer.defaultCheck.cover_for_personal_accident_benefit}  className='p-2 rounded-md cursor-pointer border-gray-soft-strong text-green-deep focus:ring-green-deep focus:ring-1' />
                </div>
              </div>
            </td>
            {totalClient.map(function (i) {
              return (
                <td key={"sdf"+i} className={``}>
                  <Input
                    ...
                    name="less"
                    dataType="coverForPersonalAccident"
                    value={section7.answer.clientData[i].coverForPersonalAccident.less}
                    handleChange={(event) => setDataClient(event, i)}
                  />
                </td>
              );
              ...
              return (
                <td key={"asss"+i} className={``}>
                  <Input
                    ...
                    name="less"
                    dataType="coverForPersonalAccident"
                    value={section7.answer.dependantData[i].coverForPersonalAccident.less}
                    handleChange={(event) => setDataDependant(event, i)}
                  />
                </td>
              );
