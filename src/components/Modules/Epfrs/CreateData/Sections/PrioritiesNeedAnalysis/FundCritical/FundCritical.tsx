                  ...
                  <td key={"asa" + i} className={``}>
                    ...
                    >
                      <div className="items-start justify-start gap-4">
                        <input
                          type="checkbox"
                          checked={section7.answer.need.client[i][2]}
                          onChange={(event) =>
                            handleClient(
                    ...
                    <td key={"asa" + i} className={``}>
                      ...
                      >
                        <div className="items-start justify-start gap-4">
                          <input
                            type="checkbox"
                            checked={section7.answer.need.dependant[i][2]}
                            onChange={(event) =>
                              handleDependant(
                                !section7.answer.need.dependant[i][2],
                                i,
                                2
                              )
                            }
            ...
            {getPfrLength.map((data, i) => (
              <td key={"asa" + i} className={``}>
                <Input
                  ...
                  value={
                    section7.answer.clientData[i].fundCriticalIllnessExpense
                      .annualAmountNeeded
                  }
                  ...
                  <Input
                    ...
                    value={
                      section7.answer.dependantData[i]
                        .fundCriticalIllnessExpense.annualAmountNeeded
                    }
              ...
              return (
                <td key={"asa" + i} className={``}>
                  <Input
                    ...
                    value={
                      section7.answer.dependantData[i]
                        .fundCriticalIllnessExpense.numberOfYearsNeed
                    }
                    handleChange={(event) => setDataDependant(event, i)}
                  />
                </td>
              ...
              return (
                <td key={"asa" + i} className={``}>
                  <Input
                    ...
                    value={
                      section7.answer.dependantData[i]
                        .fundCriticalIllnessExpense.netRateOfReture
                    }
                    handleChange={(event) => setDataDependant(event, i)}
                  />
                </td>
              ...
              return (
                <td key={"asa" + i} className="align-top">
                  <TextSmall className="text-right uppercase text-green-deep">
                    ...
                    {
                      section7.answer.dependantData[i]
                        .fundCriticalIllnessExpense.capitalSumRequired
                    }
                  </TextSmall>
                </td>
              );
              ...
              return (
                <td key={"asa" + i} className={``}>
                  <Input
                    ...
                    value={
                      section7.answer.dependantData[i]
                        .fundCriticalIllnessExpense.medicalExpense
                    }
                    handleChange={(event) => setDataDependant(event, i)}
                  />
                </td>
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="col-span-1 mt-2">
                  <input
                    ...
                    name="fund_critical_illness_expense_mortgage"
                    checked={
            ...
            {totalDependant.map(function (i) {
              return (
                <td key={"asa" + i} className={``}>
                  <Input
                    readonly={section7.answer.need.dependant[i]
                      ?!section7.answer.need.dependant[i][2] || !section7.answer.defaultCheck
                      .fund_critical_illness_expense_mortgage
                      : true}
                    formStyle="text-right"
                    className="mb-10"
                    ...
                    value={
                      section7.answer.dependantData[i]
                        .fundCriticalIllnessExpense.mortgage
                    }
                    handleChange={(event) => setDataDependant(event, i)}
                  />
                </td>
              ...
              return (
                <td key={"asa" + i} className={``}>
                  <Input
                    ...
                    value={
                      section7.answer.dependantData[i]
                        .fundCriticalIllnessExpense.loans
                    }
                    handleChange={(event) => setDataDependant(event, i)}
                  />
                </td>
              ...
              return (
                <td key={"asa" + i} className="align-top">
                  <TextSmall className="text-right uppercase text-green-deep">
                    ...
                    {
                      section7.answer.dependantData[i]
                        .fundCriticalIllnessExpense.totalCashOutflow
                    }
                  </TextSmall>
                </td>
              );
              ...
              return (
                <td key={"asa" + i} className="align-top">
                  <TextSmall className="text-right uppercase text-green-deep">
                    ...
                    {
                      section7.answer.dependantData[i]
                        .fundCriticalIllnessExpense.total
                    }
                  </TextSmall>
                </td>
              );
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="col-span-1 mt-2">
                  <input
                    type="checkbox"
                    onChange={handleDefaultCheck}
                    name="fund_critical_illness_expense_ci"
                    checked={
                      section7.answer.defaultCheck
              ...
              return (
                <td key={"asa" + i} className={``}>
                  <Input
                    ...
                    value={
                      section7.answer.dependantData[i]
                        .fundCriticalIllnessExpense.existingResources
                    }
                    handleChange={(event) => setDataDependant(event, i)}
                  />
                </td>
              ...
              return (
                <td key={"asa" + i} className="align-top">
                  <TextSmall className="text-right uppercase text-green-deep">
                    ...
                    {
                      section7.answer.dependantData[i]
                        .fundCriticalIllnessExpense.netAmountRequired
                    }
                  </TextSmall>
                </td>
              );
