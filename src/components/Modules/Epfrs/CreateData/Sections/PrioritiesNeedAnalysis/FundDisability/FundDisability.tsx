              ...
              return (
                <td className={``}>
                  <Input
                    ...
                    value={section7.answer.clientData[i].fundDisabilityIncomeExpense.annualAmountNeeded}
              ...
              return (
                <td className={``}>
                  <Input
                    ...
                    name="annualAmountNeeded"
                    dataType="fundDisabilityIncomeExpense"
                    value={section7.answer.dependantData[i].fundDisabilityIncomeExpense.annualAmountNeeded}
              ...
              return (
                <td className={``}>
                  <Input
                    ...
                    dataType="fundDisabilityIncomeExpense"
                    value={section7.answer.clientData[i].fundDisabilityIncomeExpense.numberOfYearsNeed}
                    handleChange={(event) => setDataClient(event, i)}
                  />
                </td>
              );
              ...
              return (
                <td className={``}>
                  <Input
                    ...
                    name="numberOfYearsNeed"
                    dataType="fundDisabilityIncomeExpense"
                    value={section7.answer.dependantData[i].fundDisabilityIncomeExpense.numberOfYearsNeed}
                    handleChange={(event) => setDataDependant(event, i)}
                  />
                </td>
              );
              ...
              return (
                <td className={``}>
                  <Input
                    ...
                    dataType="fundDisabilityIncomeExpense"
                    value={section7.answer.clientData[i].fundDisabilityIncomeExpense.netRateOfReture}
                    handleChange={(event) => setDataClient(event, i)}
                  />
                </td>
              );
              ...
              return (
                <td className={``}>
                  <Input
                    ...
                    name="netRateOfReture"
                    dataType="fundDisabilityIncomeExpense"
                    value={section7.answer.dependantData[i].fundDisabilityIncomeExpense.netRateOfReture}
                    handleChange={(event) => setDataDependant(event, i)}
                  />
                </td>
              );
              ...
              return (
                <td className={``}>
                  <Input
                    ...
                    name="medicalExpense"
                    dataType="fundDisabilityIncomeExpense"
                    value={section7.answer.clientData[i].fundDisabilityIncomeExpense.medicalExpense}
                    handleChange={(event) => setDataClient(event, i)}
                  />
                </td>
              );
              ...
              return (
                <td className={``}>
                  <Input
                    ...
                    name="medicalExpense"
                    dataType="fundDisabilityIncomeExpense"
                    value={section7.answer.dependantData[i].fundDisabilityIncomeExpense.medicalExpense}
                    handleChange={(event) => setDataDependant(event, i)}
                  />
                </td>
              );
              ...
              return (
                <td className={``}>
                  <Input
                    ...
                    name="mortgage"
                    dataType="fundDisabilityIncomeExpense"
                    value={section7.answer.clientData[i].fundDisabilityIncomeExpense.mortgage}
                    handleChange={(event) => setDataClient(event, i)}
                  />
                </td>
              );
              ...
              return (
                <td className={``}>
                  <Input
                    ...
                    name="mortgage"
                    dataType="fundDisabilityIncomeExpense"
                    value={section7.answer.dependantData[i].fundDisabilityIncomeExpense.mortgage}
                    handleChange={(event) => setDataDependant(event, i)}
                  />
                </td>
              );
              ...
              return (
                <td className={``}>
                  <Input
                    ...
                    name="loans"
                    dataType="fundDisabilityIncomeExpense"
                    value={section7.answer.clientData[i].fundDisabilityIncomeExpense.loans}
                    handleChange={(event) => setDataClient(event, i)}
                  />
                </td>
              );
              ...
              return (
                <td className={``}>
                  <Input
                    ...
                    name="loans"
                    dataType="fundDisabilityIncomeExpense"
                    value={section7.answer.dependantData[i].fundDisabilityIncomeExpense.loans}
                    handleChange={(event) => setDataDependant(event, i)}
                  />
                </td>
              );
              ...
              return (
                <td className={``}>
                  <Input
                    ...
                    dataType="fundDisabilityIncomeExpense"
                    value={section7.answer.clientData[i].fundDisabilityIncomeExpense.existingInsuranceCoverageOnDisability}
                    handleChange={(event) => setDataClient(event, i)}
                  />
                </td>
              );
              ...
              return (
                <td className={``}>
                  <Input
                    ...
                    dataType="fundDisabilityIncomeExpense"
                    value={section7.answer.dependantData[i].fundDisabilityIncomeExpense.existingInsuranceCoverageOnDisability}
                    handleChange={(event) => setDataDependant(event, i)}
                  />
                </td>
              );
              ...
              return (
                <td className={``}>
                  <Input
                    ...
                    dataType="fundDisabilityIncomeExpense"
                    value={section7.answer.clientData[i].fundDisabilityIncomeExpense.existingResources}
                    handleChange={(event) => setDataClient(event, i)}
                  />
                </td>
              );
              ...
              return (
                <td className={``}>
                  <Input
                    ...
                    name="existingResources"
                    dataType="fundDisabilityIncomeExpense"
                    value={section7.answer.dependantData[i].fundDisabilityIncomeExpense.existingResources}
                    handleChange={(event) => setDataDependant(event, i)}
                  />
                </td>
              );
