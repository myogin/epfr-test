    ...
    <SectionCardSingleGrid className="mx-8 2xl:mx-60">
      <table className="border-separate table-auto border-spacing-5">
        <tbody className="">
                  ...
                  <td key={"asasd" + i} className={``}>
                    ...
                    >
                      <div className="items-start justify-start gap-4">
                        <input
                          type="checkbox"
                          checked={section7.answer.need.client[i][11]}
                          onChange={(event) =>
                            handleClient(
                              !section7.answer.need.client[i][11],
                              i,
                              11
                            )
                          }
            ...
            {getPfrLength.map((data, i) => (
                <td key={"asasd" + i} className={``}>
                  <Input
                    ...
                    value={
                      section7.answer.clientData[i].otherInsures
                        .frequencyOfTravel
                    }
                  ...
                  <td key={"asasd" + i} className={``}>
                    ...
                    >
                      <div className="items-start justify-start gap-4">
                        <input
                          type="checkbox"
                          checked={section7.answer.need.client[i][12]}
                          onChange={(event) =>
                            handleClient(
                              !section7.answer.need.client[i][12],
                              i,
                              12
                            )
                          }
          ...
          <tr>
            <td className="w-1/2 align-top">
              <TextSmall className="text-gray-light">Company Name</TextSmall>
            </td>
            {getPfrLength.map((data, i) => (
                <td key={"asasd" + i} className={``}>
                  <Input
                    ...
                    dataType="otherInsures"
                    value={
                      section7.answer.clientData[i].otherInsures.companyName
                    }
                    handleChange={(event) => setDataClient(event, i)}
                  />
                </td>
          ...
          <tr>
            <td className="w-1/2 align-top">
              <TextSmall className="text-gray-light">Renewal Date</TextSmall>
            </td>
            {getPfrLength.map((data, i) => (
                <td key={"asasd" + i} className={``}>
                  <Input
                    ...
                    dataType="otherInsures"
                    value={
                      section7.answer.clientData[i].otherInsures.renewalDate
                    }
                    handleChange={(event) => setDataClient(event, i)}
                  />
                </td>
          ...
          <tr>
            <td className="align-top">
              <TextSmall className="uppercase text-gray-light">
                Would you be interested in knowing more and / or receiving
                quotes on the following range of insurance(s)?
              </TextSmall>
            </td>
            {total > 1
              ? getPfrLength.map((data, i) => (
                  <td key={"asasd" + i} className={``}>
                    ...
                    >
                      <div className="items-start justify-start gap-4">
                        <input
                          type="checkbox"
                          checked={section7.answer.need.client[i][13]}
                          onChange={(event) =>
                            handleClient(
                              !section7.answer.need.client[i][13],
                              i,
                              13
                            )
                          }
            ...
            {getPfrLength.map((data, i) => (
                <td key={"asasd" + i} className={``}>
                  <Select
                    ...
                    dataType="otherInsures"
                    value={
                      section7.answer.clientData[i].otherInsures.groupInsurance
                    }
                    datas={interestGroup}
                    handleChange={(event) => setDataClient(event, i)}
                  />
